...
interface ReactiveCrud<X> {
  ...
  <T extends Identifiable<Integer>> ReactiveTable.Extras<T> readAsync(Table<T, ? super X> table) throws TableError;

  <T extends Identifiable<Integer>> Maybe<IdentifiableList<? extends T>> readAllAsync(Table<T, ? super X> table);

  <T extends Identifiable<Integer>> Maybe<IdentifiableList<? extends T>> readAllAsync(Table<T, ? super X> table, Column... column);
  ...
  <T extends Identifiable<Integer>> Single<Boolean> saveAsync(IdentifiableList<? extends T> list, Table<T, ? super X> table);
