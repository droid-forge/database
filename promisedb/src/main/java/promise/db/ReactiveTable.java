...
public interface ReactiveTable {
  ...
  interface Extras<T extends Identifiable<Integer>> {
     ...
     */
    Maybe<SList<? extends T>> limit(int limit);
     ...
     * @return a list of records
     */
    Maybe<SList<? extends T>> paginate(int skip, int limit);
     ...
     */
    <N extends Number> Maybe<SList<? extends T>> between(Column<N> column, N a, N b);
     ...
     */
    Maybe<SList<? extends T>> where(Column... column);
     ...
     */
   <N extends Number> Maybe<SList<? extends T>> notIn(Column<N> column, N... bounds);
     ...
     * @return list of records
     */
    Maybe<SList<? extends T>> like(Column<String>... column);
     ...
     */
    Maybe<SList<? extends T>> orderBy(Column column);
     ...
     */
    Maybe<SList<? extends T>> groupBy(Column column);
     ...
     */
    Maybe<SList<? extends T>> groupAndOrderBy(Column column, Column column1);
  }
}
