...
interface Crud<X> {
  ...
  <T extends Identifiable<Integer>> IdentifiableList<? extends T> findAll(Table<T, ? super X> table);
  ...
  <T extends Identifiable<Integer>> IdentifiableList<? extends T> findAll(Table<T, ? super X> table, Column... columns);
  ...
  <T extends Identifiable<Integer>> boolean save(IdentifiableList<? extends T> list, Table<T, ? super X> table);
